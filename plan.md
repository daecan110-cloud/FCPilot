...
| Sprint | 내용 | 크기 |
|--------|------|------|
| 11 | UI 리뉴얼 + 잔여 버그 + 텔레그램 버그 | 2~3일 |
| 12 | 카카오맵 전환 + 동선 최적화(#23) | 2~3일 |
| 13 | 실사용 테스트 + 피드백 + UX 개선 | 1~2주 |
| 14 | 동료 FC 온보딩 + 봇 분리(#15) | 1주 |
| 15 | 생일알림(#21) + Daily Reminder(#19) + 자동백업(#25) | 3~4일 |
| 16 | 보장분석 비교(#22) + 셀 병합 검증(#18) + 리팩토링(#17) | 3~4일 |
| 17 | 상담 스크립트(#26) + 약관 AI 대화창(#16, API 여유 시) + PWA(#24) | 1주 |
