...
| 16 | 기계약자 계약관리 + 상품 판매 통계 + 유입경로 디버깅 | 진행 중 |
| 17 | 생일알림(#21) + Daily Reminder(#19) + 자동백업(#25) | 3~4일 |
| 18 | 보장분석 비교(#22) + 셀 병합 검증(#18) + 리팩토링(#17) | 3~4일 |
| 19 | 상담 스크립트(#26) + 약관 AI 대화창(#16, API 여유 시) + PWA(#24) | 1주 |
